        ...
        else if(password!==pass1)
        {
          ...
          setTimeout(() => {
            ...
            const post=()=>{
              ...
              axios.post("http://localhost:3001/users",{"Name":name,"Email":email,"Password":password});
            }
            try{
              post();
              setSuccess(true);
...
<div class="box-1">
  <div class="btn btn-one">
    <span style={{fontFamily: "'Josefin Sans', sans-serif",fontWeight:"700"}}>Return to Home</span>
  </div>
</div></Typography>
  </Grid>
</Grid>
